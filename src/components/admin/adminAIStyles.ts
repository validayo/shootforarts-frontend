export const aiStatusClassByKey: Record<string, string> = {
  ...
  edited: "bg-violet-50 text-violet-700 ring-1 ring-violet-100",
  ...
  send_failed: "bg-rose-50 text-rose-700 ring-1 ring-rose-100",
