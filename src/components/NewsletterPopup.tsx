...
const NewsletterPopup: React.FC = () => {
  ...
  const closePopup = (suppressDays: number = 14) => {
    ...
    <AnimatePresence>
      {open && (
        ...
        >
          ...
          <div className="absolute inset-0 bg-black/40 backdrop-blur-sm" onClick={() => closePopup(14)} />
              ...
              <div className="md:col-span-7 p-6 md:p-8">
                ...
                {!success ? (
                  ...
                  <div className="mt-6">
                    ...
                    <button onClick={() => closePopup(14)} className="mt-4 inline-flex items-center px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800">Close</button>
                  </div>
                )}
              </div>
            </div>
