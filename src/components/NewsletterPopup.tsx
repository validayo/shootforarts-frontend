...
const NewsletterPopup: React.FC = () => {
  ...
  const shouldShow = useMemo(() => typeof window !== "undefined" && !sessionStorage.getItem(SESSION_KEY), []);
          ...
          >
            ...
            <div className="relative grid md:grid-cols-12">
              ...
              <div className="md:col-span-5 p-6 md:p-8 bg-gradient-to-br from-gray-50 to-white">
                <div className="h-40 md:h-60 w-full rounded-xl bg-gray-200" />
              </div>
              ...
              <div className="md:col-span-7 p-6 md:p-8">
                ...
                {!success ? (
                  ...
                  <div className="mt-6">
                    ...
                    <button onClick={closePopup} className="mt-4 inline-flex items-center px-4 py-2 bg-gray-900 text-white rounded-lg hover:bg-gray-800">Close</button>
                  </div>
                )}
              </div>
            </div>
