...
- [Ops Runbook](../workflows/ops-runbook.md)
- [Admin Login Security](../admin/security/admin-login-security.md)
...
- `src/features/`: feature-owned modules, pages, tests, and local utilities.
...
- `/about` -> [`src/pages/public/AboutPage.tsx`](../src/pages/public/AboutPage.tsx)
  Renders branded/about content from [`src/features/about/components/About.tsx`](../src/features/about/components/About.tsx).
...
- Homepage gallery behavior:
  [`src/features/gallery/components/Gallery.tsx`](../src/features/gallery/components/Gallery.tsx)
...
- Contact form questions/options:
  [`src/features/contact/components/ContactForm.tsx`](../src/features/contact/components/ContactForm.tsx), [`src/utils/options.ts`](../src/utils/options.ts)
- Admin table columns/filters:
  [`src/features/admin/data/components/AdminData.tsx`](../src/features/admin/data/components/AdminData.tsx)
